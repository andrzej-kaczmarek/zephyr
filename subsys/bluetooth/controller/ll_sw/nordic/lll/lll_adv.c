...
/* ToDo change to Kconfig option */
#if defined(CONFIG_BT_CTLR_ADV_SYNC_CHAIN_LEN_MAX)
#define PDU_ADV_SYNC_CHAIN_COUNT CONFIG_BT_CTLR_ADV_SYNC_CHAIN_LEN_MAX
#else
#define PDU_ADV_SYNC_CHAIN_COUNT 0
#endif /* CONFIG_BT_CTLR_ADV_SYNC_CHAIN_LEN_MAX */
...
#define PDU_MEM_COUNT_MIN  (BT_CTLR_ADV_SET + \
			    ...
			    (BT_CTLR_ADV_SET * PDU_ADV_SYNC_CHAIN_COUNT * 2))
