...
#define LL_ADV_INTF_ANY    0 /* Any advertising cmd/evt allowed */
#define LL_ADV_INTF_LEGACY 1 /* Only legacy advertising cmd/evt allowed */
#define LL_ADV_INTF_EXT    2 /* Only extended advertising cmd/evt allowed */
...
int ll_adv_intf_set(uint8_t intf);
int ll_adv_intf_is_ext(void);
#else
static inline int ll_adv_intf_is_ext(void)
{
	return 1;
}
